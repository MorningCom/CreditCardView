...
public class MainActivityTest {
    ...
    public void mainActivityTest() {
        ...
        onView(withId(R.id.add_card))
                .perform(scrollTo(), click());

        onView(withId(R.id.card_number_field))
                .perform(typeText("4970 1000 0000 0000"), closeSoftKeyboard());

        onView(withId(R.id.card_expiry))
                .perform(typeText("1223"), closeSoftKeyboard());

        onView(withId(R.id.card_cvv))
                .perform(typeText("123"), closeSoftKeyboard());

        onView(withId(R.id.card_name))
                .perform(typeText("JEAN MARTIN"), closeSoftKeyboard());

        onView(withId(R.id.next))
                .check(matches(withText("TERMINER")))
                .perform(click());
